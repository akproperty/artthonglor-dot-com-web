...
#
#     PHX_SERVER=true bin/artthonglor start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :artthonglor, ArtthonglorWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  #     config :artthonglor, Artthonglor.Endpoint,
  #       https: [
  #         ...,
  #         port: 443,
  #         cipher_suite: :strong,
  ...
  #
  #     config :artthonglor, Artthonglor.Mailer,
